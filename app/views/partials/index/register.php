...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Daftar</h4>
                </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-tahun_lulus"  value="<?php  echo $this->set_field_value('tahun_lulus',""); ?>" type="text" placeholder="Masukan Tahun Lulus"  required="" name="tahun_lulus"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                                <input id="ctrl-password"  value="<?php  echo $this->set_field_value('password',""); ?>" type="password" placeholder="Masukan Password"  required="" name="password"  class="form-control  password password-strength" />
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select required=""  id="ctrl-pekerjaan_saat_ini" name="pekerjaan_saat_ini"  placeholder="Masukan Pekerjaan Saat Ini"    class="custom-select" >
                                                                                <option value="">Masukan Pekerjaan Saat Ini</option>
                                                                                <?php
