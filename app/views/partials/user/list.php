            ...
            <div class="row ">
                <div class="col comp-grid">
                    <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                        <div class="card mb-3">
                            <div class="card-header h4 h4">Filter by User Tahun Lulus</div>
                            <div class="p-2">
                                <?php 
                                $to = 10;
                                $from = 0;
                                if(!empty($_GET['user_tahun_lulus'])){
                                $range = explode('-', get_value('user_tahun_lulus'));
                                $from = $range[0];
                                $to = (!empty($range[1]) ? $range[1] : null);
                                }
                                ?>
                                <input class="ion-range" type="text" data-from="<?php echo $from ?>" data-to="<?php echo $to ?>" data-force_edge="true" data-prefix="" data-postfix=""  name="user_tahun_lulus" data-step="1" data-type="double" data-min="2018"   data-max="2024"   data-grid="true" data-grid-snap="true" /> 
                                </div>
                            </div>
                            <hr />
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active fade" id="TabPage-1-Page1" role="tabpanel">
                                        ...
                                        <div class="filter-tags mb-2">
                                            <?php
                                            if(!empty(get_value('user_tahun_lulus'))){
                                            ?>
                                            <div class="filter-chip card bg-light">
                                                <b>User Tahun Lulus :</b> 
                                                <?php 
                                                if(get_value('user_tahun_luluslabel')){
                                                echo get_value('user_tahun_luluslabel');
                                                }
                                                else{
                                                echo get_value('user_tahun_lulus');
                                                }
                                                $remove_link = unset_get_value('user_tahun_lulus', $this->route->page_url);
                                                ?>
                                                            ...
                                                            <div class=" border-top mt-2">
                                                                <div class="row justify-content-center">    
                                                                                    ...
                                                                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                                                                        ...
                                                                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                                                                            ...
                                                                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                                                                ...
                                                                                                <?php Html :: import_form('user/import_data' , "Import Data", 'JSON'); ?>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col">   
                                                                                            <?php
                                                                    ...
                                                                    <div class="tab-pane  fade" id="TabPage-1-Page2" role="tabpanel">
                                                                        <div class=" ">
                                                                            <?php  
                                                                            $this->render_page("user/alumni/user.user_role_id/2?limit_count=20" , array( 'show_header' => false )); 
                                                                            ?>
                                                                        </div>
                                                                    </div>
                                                                    <div class="tab-pane  fade" id="TabPage-1-Page3" role="tabpanel">
                                                                        <div class=" ">
                                                                            <?php  
                                                                            $this->render_page("user/admin/user.user_role_id/1?limit_count=20"); 
                                                                            ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
