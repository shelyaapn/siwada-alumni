                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-judul_pengumuman"  value="<?php  echo $data['judul_pengumuman']; ?>" type="text" placeholder="Masukan Judul"  required="" name="judul_pengumuman"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <textarea placeholder="Masukan Isi" id="ctrl-isi_pengumuman"  required="" rows="5" name="isi_pengumuman" class=" form-control"><?php  echo $data['isi_pengumuman']; ?></textarea>
