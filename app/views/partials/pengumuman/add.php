...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Tambahkan Pengumuman Baru</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-judul_pengumuman"  value="<?php  echo $this->set_field_value('judul_pengumuman',""); ?>" type="text" placeholder="Masukan Judul"  required="" name="judul_pengumuman"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <textarea placeholder="Masukan Isi" id="ctrl-isi_pengumuman"  required="" rows="5" name="isi_pengumuman" class=" form-control"><?php  echo $this->set_field_value('isi_pengumuman',""); ?></textarea>
