...
class PengumumanController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$fields = array("pengumuman.id_pengumuman", 
			"pengumuman.judul_pengumuman", 
			"pengumuman.photo", 
			"pengumuman.tanggal_diubah", 
			"pengumuman.editor", 
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				pengumuman.photo LIKE ? OR 
				pengumuman.tanggal_diubah LIKE ? OR 
				pengumuman.editor LIKE ?
			)";
			$search_params = array(
		...
		$db->join("user", "pengumuman.editor = user.id_user", "INNER");
	...
	function view($rec_id = null, $value = null){
		...
		if($record){
			$page_title = $this->view->page_title = "Detail Pengumuman";
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("judul_pengumuman","isi_pengumuman","photo","tanggal_diubah","editor");
...
$modeldata['editor'] = USER_ID;
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_pengumuman","judul_pengumuman","isi_pengumuman","photo","tanggal_diubah","editor");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'judul_pengumuman' => 'required',
