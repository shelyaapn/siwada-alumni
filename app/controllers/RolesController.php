...
class RolesController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$db->join("user", "roles.editor = user.id_user", "INNER");
		...
		$page_title = $this->view->page_title = "Peran Pengguna";
	...
	function editfield($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		//editable fields
		$fields = $this->fields = array("role_id","role_name","tanggal_diubah","editor");
		$page_error = null;
		if($formdata){
			$postdata = array();
