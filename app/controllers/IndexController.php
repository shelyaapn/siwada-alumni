...
class IndexController extends BaseController{
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("nama","jenis_kelamin","tahun_lulus","jurusan","email","password","no_telepon","alamat","pekerjaan_saat_ini","photo","account_status","user_role_id"); //registration fields
